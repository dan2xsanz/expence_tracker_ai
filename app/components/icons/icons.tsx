...
const SackMoneyIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 512 512" width={35} height={35} fill={"#2285807c"}>
...
const SavingIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 576 512" width={40} height={40} fill={"#2285807c"}>
...
const RemittanceIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 640 512" width={35} height={35} fill={"#2285807c"}>
...
const ElypsisIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 448 512" width={35} height={35} fill={"#2285807c"}>
...
const MoneyCheckIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 576 512" width={35} height={35} fill={"#2285807c"}>
...
const CreditCardIcon = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 576 512" width={30} height={30} fill={"#2285807c"}>
