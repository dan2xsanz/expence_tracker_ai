...
const PesoSign = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 384 512" width={30} height={30} fill={"#187571ff"}>
...
const DollarSign = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 320 512" width={30} height={30} fill={"#187571ff"}>
...
const EuroSign = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 320 512" width={30} height={30} fill={"#187571ff"}>
...
const YenSign = ({ onPress }: IconStyleInterface) => {
  return (
    <TouchableOpacity onPress={onPress}>
      <Svg viewBox="0 0 320 512" width={30} height={30} fill={"#187571ff"}>
